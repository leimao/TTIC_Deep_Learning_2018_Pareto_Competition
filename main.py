...
'''
Hierarchical Softmax in Language Modeling
Lei Mao
University of Chicago

Please download additional files, including a README.md and a generate_hsoftmax.py from my Canvas. 
The original generate.py will not for hierarchical softmax, please use the generate_hsoftmax.py that I provided to generate a sample essay.

Please run the following parameters to train the model:
